...
plot(Power_Subset$DateTime,Power_Subset$Global_active_power, pch=NA, xlab="", ylab="Global Active Power (kilowatts)")
lines(Power_Subset$DateTime, Power_Subset$Global_active_power)
## Plot 2 
plot(Power_Subset$DateTime, Power_Subset$Voltage, ylab="Voltage", xlab="datetime", pch=NA)
